  ...
  main() : Object {
     {
       ...
       iota(in_int()).print_list();
       out_string("\n");
       (new Cons).init(3, (new Cons).init(7, (new Cons).init(8, (new Cons).init(5,(new Nil))))).print_list();
       out_string("\n");
       (new Cons).init(3, (new Cons).init(7, (new Cons).init(8, (new Cons).init(5,(new Nil))))).rev().print_list();
       out_string("\n");
       (new Cons).init(3, (new Cons).init(7, (new Cons).init(8, (new Cons).init(5,(new Nil))))).sort().print_list();
       out_string("\n");
       (new Cons).init(3, (new Cons).init(7, (new Cons).init(8, (new Cons).init(5,(new Nil))))).rev().sort().print_list();
       out_string("\n");
       (new Cons).init(3, (new Cons).init(7, (new Cons).init(8, (new Cons).init(5,(new Nil))))).rev().sort().rev().print_list();
       out_string("\n");
     }
  };
};          
