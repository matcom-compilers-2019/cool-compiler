...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _attempt_bool.143
lw $a0, -16($sp)
beqz $a0, _attempt_bool.143
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -24($sp)
# t3 = Call _wrapper.Int;
sw $ra, -20($sp)
addiu $sp, $sp, -24
jal _wrapper.Int
addiu $sp, $sp, 24
...
sw $v0, -12($sp)
# PopParam 1;
# Goto _not_more_attempt.143
j _not_more_attempt.143
# _attempt_bool.143:
...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _attempt_string.143
lw $a0, -16($sp)
beqz $a0, _attempt_string.143
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -24($sp)
# t3 = Call _wrapper.Bool;
sw $ra, -20($sp)
addiu $sp, $sp, -24
jal _wrapper.Bool
addiu $sp, $sp, 24
...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _not_more_attempt.143
lw $a0, -16($sp)
beqz $a0, _not_more_attempt.143
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -24($sp)
# t3 = Call _wrapper.String;
sw $ra, -20($sp)
addiu $sp, $sp, -24
jal _wrapper.String
addiu $sp, $sp, 24
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_bool.181
lw $a0, -12($sp)
beqz $a0, _attempt_bool.181
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -24($sp)
...
sw $v0, -8($sp)
# PopParam 1;
# Goto _not_more_attempt.181
j _not_more_attempt.181
# _attempt_bool.181:
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_string.181
lw $a0, -12($sp)
beqz $a0, _attempt_string.181
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -24($sp)
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _not_more_attempt.181
lw $a0, -12($sp)
beqz $a0, _not_more_attempt.181
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -24($sp)
